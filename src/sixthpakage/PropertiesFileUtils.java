   ...
   /* public  static int getResult(int a, int b){
       ...
       /* int data1 = getResult(10,20);
        ...
        System.out.println(data2);*/
            ...
            String value1 = getDataFromPropertiesFile("src/sixthpakage/config.properties", "dbUser");
            System.out.println(value1);

            String value2 = getDataFromPropertiesFile("src/sixthpakage/config2.properties", "course");
